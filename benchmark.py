...
def detect(opt):
    ...
    elif net_name in ['ofa_fadnet']:
        net = build_net(net_name)(width_mult=1.0,
                                  ks_list=[3, 5, 7], expand_ratio_list=8, depth_list=4,
                                  )
    ...
    with torch.no_grad():
        for rep in range(repetitions):
            ...
            print('repetition times:{}, current time cost:{}'.format(rep, curr_time))
